...
CTRL_LIST_ITEM(UIMenuRadarSetting_Status_KReport)
CTRL_LIST_ITEM(UIMenuRadarSetting_Status_KAReport)
CTRL_LIST_ITEM(UIMenuRadarSetting_Status_XReport)
CTRL_LIST_ITEM(UIMenuRadarSetting_Status_DrivingMode)
CTRL_LIST_ITEM(UIMenuRadarSetting_Status_OverSpeed)
CTRL_LIST_ITEM(UIMenuRadarSetting_Status_Vol)
CTRL_LIST_END
...
//----------------------UIMenuRadarSetting_Status_KReportCtrl Event---------------------------
EVENT_BEGIN(UIMenuRadarSetting_Status_KReport)
EVENT_END

//----------------------UIMenuRadarSetting_Status_KAReportCtrl Event---------------------------
EVENT_BEGIN(UIMenuRadarSetting_Status_KAReport)
EVENT_END
...
//----------------------UIMenuRadarSetting_Status_OverSpeedCtrl Event---------------------------
EVENT_BEGIN(UIMenuRadarSetting_Status_OverSpeed)
EVENT_END

//----------------------UIMenuRadarSetting_Status_VolCtrl Event---------------------------
EVENT_BEGIN(UIMenuRadarSetting_Status_Vol)
EVENT_END
