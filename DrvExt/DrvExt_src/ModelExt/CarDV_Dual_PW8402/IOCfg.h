...
#define GPIO_TP_RESET             P_GPIO_40
#define GPIO_TP_POWER             D_GPIO_1
...
#define PAD_TP_RESET                   PAD_PIN_PGPIO40  //SIF channel 0

#define TP_GPIO_INT     GPIO_INT_00
...
#define GPIO_CMD_MODE_KEY              P_GPIO_7
#define PAD_CMD_MODE_KEY              PAD_PIN_PGPIO7

#define GPIO_CMD_PWR_KEY              P_GPIO_51
#define PAD_CMD_PWR_KEY              PAD_PIN_PGPIO51
...
#define GPIO_SENSOR_PWM2            P_GPIO_50//P_GPIO_51
...
#define GPIO_SENSOR2_DET         P_GPIO_8//C_GPIO_27
#define PAD_SENSOR2_DET            PAD_PIN_PGPIO8//      PAD_PIN_CGPIO27
...
extern void GPIO_CLEAR_CMD_MODE_KEY(void);

extern void GPIO_SET_CMD_MODE_KEY(void);


extern BOOL GPIO_GET_CMD_MODE_KEY(void);

extern void GPIO_CLEAR_CMD_PWR_KEY(void);

extern void GPIO_SET_CMD_PWR_KEY(void);

extern BOOL GPIO_GET_CMD_PWR_KEY(void);
//--------------------------------------------------------------------
// Storbe device
//--------------------------------------------------------------------
// STROBE
...
// DVR Status
#define GPIO_DVR_STATUS                P_GPIO_10
#define PAD_DVR_STATUS                 PAD_PIN_PGPIO10 
