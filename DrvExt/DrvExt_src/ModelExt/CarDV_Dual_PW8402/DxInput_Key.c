...
#define PW84_KEY_BOARD_HLYD   1
#define PW84_KEY_BOARD_F84   2


#define KEY_BOARD_TYPE   PW84_KEY_BOARD_F84// PW84_KEY_BOARD_AIDUOSHI_6KEYS//
...
#if (ADC_KEY == ENABLE)
#if(KEY_BOARD_TYPE==PW84_KEY_BOARD_HLYD)
