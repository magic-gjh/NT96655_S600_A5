...
BOOL GSensor_DA380_ParkingMode(void)
{
	...
	GSensor_I2C_WriteReg(NSA_REG_ACTIVE_THRESHOLD,0x26 );////DEBUG//38//DF
	 GSensor_I2C_WriteReg(NSA_REG_INTERRUPT_SETTINGS2,0xA0); // interuppt plus  keep 1 second
#if 1
			GSensor_I2C_WriteReg(NSA_REG_INT_PIN_CONFIG,0x01 );//res = mir3da_register_write(NSA_REG_INT_PIN_CONFIG,0x01 );
