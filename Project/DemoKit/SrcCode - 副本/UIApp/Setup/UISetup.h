...
//#NT#2012/07/04#Philex Lin -begin
    ...
    //Edog event
    NVTEVT_EXE_EDOGMODE,
    NVTEVT_EXE_EDOGVOLUME,
    NVTEVT_EXE_EDOGMUTE,
    NVTEVT_EXE_EDOGDRIVEMODE,
    NVTEVT_EXE_EDOGSENSITY,
    NVTEVT_EXE_EDOGSPEED_LIMIT,
    NVTEVT_EXE_EDOGSPEED_ADJUST,
    NVTEVT_EXE_EDOGBROADCAST,
    NVTEVT_EXE_EDOG_DEFAULT,     
}
CUSTOM_SYS_EVENT;
