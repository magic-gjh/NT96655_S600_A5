...
SHOW_ITEM_GROUP(CMD_Group,Normal4,312,250,527,287)
...
SHOW_ITEM_GROUP(CMD_Group,Focused8,312,250,527,287)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable19,312,250,527,287)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable23,312,250,527,287)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed27,312,250,527,287)
...
CREATE_LIST_CTRL(UIMenuWndSetupDefaultSetting_List_Text,UIMenuWndSetupDefaultSetting_List_Text,0,312,250,527,287)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
CREATE_STATIC_CTRL(UIMenuWndSetupDefaultSetting_Static_Text,0,266,150,565,213)
