...
INT32 UIMenuWndSetupCarNumber_TP(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_TP,UIMenuWndSetupCarNumber_TP)
EVENT_END
...
INT32 UIMenuWndSetupCarNumber_TP(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32 uiEvent;
    UINT32 P1,P2;
    UINT32  uiSoundMask;
