...
SHOW_ITEM_RECT(CMD_Rectangle,Rect4,-1,-3,718,386,272,0,14,255,0,0,0)
SHOW_ITEM_RECT(CMD_Rectangle,Skin2Rect,0,0,715,383,0,0,255,255,0,0,0)
SHOW_MAP_BEGIN(Skin2)
SHOW_MAP_BODY(Skin2Rect)
SHOW_MAP_BODY(Rect4)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin2,0,0,715,383)
...
SHOW_ITEM_GROUP(CMD_Group,Normal5,326,141,393,197)
...
SHOW_ITEM_GROUP(CMD_Group,Focused9,326,141,393,197)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable16,326,141,393,197)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable20,326,141,393,197)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed24,326,141,393,197)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_Y,UIMenuWndSetupDateTime_YMD_Y,0,269,88,336,144)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Normal29,403,141,442,197)
...
SHOW_ITEM_GROUP(CMD_Group,Focused33,403,141,442,197)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable40,403,141,442,197)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable44,403,141,442,197)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed48,403,141,442,197)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_M,UIMenuWndSetupDateTime_YMD_M,0,346,88,385,144)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Normal53,459,141,498,197)
...
SHOW_ITEM_GROUP(CMD_Group,Focused57,459,141,498,197)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable64,459,141,498,197)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable68,459,141,498,197)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed72,459,141,498,197)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_D,UIMenuWndSetupDateTime_YMD_D,0,402,88,441,144)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Normal77,326,194,365,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused81,326,194,365,250)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable88,326,194,365,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable92,326,194,365,250)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed96,326,194,365,250)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_HR,UIMenuWndSetupDateTime_YMD_HR,0,269,141,308,197)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Normal101,403,194,442,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused105,403,194,442,250)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable112,403,194,442,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable116,403,194,442,250)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed120,403,194,442,250)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_MIN,UIMenuWndSetupDateTime_YMD_MIN,0,346,141,385,197)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Normal125,459,194,498,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused129,459,194,498,250)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable136,459,194,498,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable140,459,194,498,250)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed144,459,194,498,250)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_SEC,UIMenuWndSetupDateTime_YMD_SEC,0,402,141,441,197)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(Skin150)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin150,0,0,59,79)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text152,2,20,57,59,STRID_NULL,0,0,0,0,2,1,1,256,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal149)
SHOW_MAP_BODY(Skin150)
SHOW_MAP_BODY(Text152)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal149,320,250,379,329)

SHOW_ITEM_IMAGE(CMD_Image,Image_Sel_Bar155, 13, 24, 44,51, ICON_SEL_BAR_DATE,83886080,0,0,0,0,0,0,0)
SHOW_ITEM_IMAGE(CMD_Image,Image_Up156, 20, 6, 37,19, ICON_DIR_UP,83886080,0,0,0,0,0,0,0)
SHOW_ITEM_IMAGE(CMD_Image,Image_Down157, 20, 60, 33,71, ICON_DIR_DOWN,83886080,0,0,0,0,0,0,0)
SHOW_ITEM_RECT(CMD_Rectangle,Skin154Rect,0,0,59,79,0,0,255,255,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Skin154,0,0,59,79)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text159,2,20,57,59,STRID_NULL,0,0,0,0,14,1,1,256,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Focused153)
SHOW_MAP_BODY(Skin154)
SHOW_MAP_BODY(Text159)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Focused153,320,250,379,329)

SHOW_ITEM_RECT(CMD_Rectangle,Skin161Rect,0,0,59,79,0,0,255,255,0,0,0)
SHOW_MAP_BEGIN(Skin161)
SHOW_MAP_BODY(Skin161Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin161,0,0,59,79)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable160,320,250,379,329)

SHOW_ITEM_RECT(CMD_Rectangle,Skin165Rect,0,0,59,79,0,0,255,255,0,0,0)
SHOW_MAP_BEGIN(Skin165)
SHOW_MAP_BODY(Skin165Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin165,0,0,59,79)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable164,320,250,379,329)

SHOW_ITEM_RECT(CMD_Rectangle,Skin169Rect,0,0,59,79,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin169)
SHOW_MAP_BODY(Skin169Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin169,0,0,59,79)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed168,320,250,379,329)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_Switch,UIMenuWndSetupDateTime_YMD_Switch,0,263,197,322,276)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(Skin173)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin173,0,0,715,383)
...
SHOW_ITEM_GROUP(CMD_Group,Normal174,382,154,402,183)
...
CREATE_STATIC_CTRL(UIMenuWndSetupDateTime_YMD_VALUE_Other0,0,324,101,344,130)
...
SHOW_ITEM_GROUP(CMD_Group,Normal179,438,154,458,183)
...
CREATE_STATIC_CTRL(UIMenuWndSetupDateTime_YMD_VALUE_Other1,0,380,101,400,130)
...
SHOW_ITEM_GROUP(CMD_Group,Normal184,382,207,402,236)
...
CREATE_STATIC_CTRL(UIMenuWndSetupDateTime_YMD_VALUE_Other2,0,324,154,344,183)
...
SHOW_ITEM_GROUP(CMD_Group,Normal189,438,207,458,236)
...
CREATE_STATIC_CTRL(UIMenuWndSetupDateTime_YMD_VALUE_Other3,0,380,154,400,183)
...
SHOW_ITEM_GROUP(CMD_Group,Normal194,380,274,484,303)
...
CREATE_STATIC_CTRL(UIMenuWndSetupDateTime_YMD_VALUE_Other4,0,322,221,426,250)
...
CREATE_TAB_CTRL(UIMenuWndSetupDateTime_Tab_YMD_VALUE,UIMenuWndSetupDateTime_Tab_YMD_VALUE,0,1,0,716,383)
...
SHOW_ITEM_GROUP(CMD_Group,Normal199,520,194,559,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused203,520,194,559,250)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable210,520,194,559,250)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable214,520,194,559,250)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed218,520,194,559,250)
...
CREATE_BUTTON_CTRL(UIMenuWndSetupDateTime_YMD_AMPM,UIMenuWndSetupDateTime_YMD_AMPM,0,463,141,502,197)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
CREATE_TAB_CTRL(UIMenuWndSetupDateTime_Tab,UIMenuWndSetupDateTime_Tab,0,57,53,772,436)
