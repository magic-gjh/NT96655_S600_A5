...
INT32 UIMenuWndSetupDateTime_TP(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_TP,UIMenuWndSetupDateTime_TP)
...
static void UIMenuWndSetupDateTime_UpdateInfo(void)
{
    ...
    Ux_RECT rect1_1_1 = { 326-DATETIME_START_X,  141-DATETIME_START_Y, 393-DATETIME_START_X, 197-DATETIME_START_Y};
    Ux_RECT rect1_1_2 = {343-DATETIME_START_X,  141-DATETIME_START_Y, 393-DATETIME_START_X, 197-DATETIME_START_Y};
    Ux_RECT rect1_2   = {403-DATETIME_START_X,  141-DATETIME_START_Y, 442-DATETIME_START_X, 197-DATETIME_START_Y};
    Ux_RECT rect1_3   = {459-DATETIME_START_X,  141-DATETIME_START_Y, 498-DATETIME_START_X, 197-DATETIME_START_Y};    
...
INT32 UIMenuWndSetupDateTime_TP(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32 uiEvent;
    UINT32 P1,P2;
    UINT32  uiSoundMask;
