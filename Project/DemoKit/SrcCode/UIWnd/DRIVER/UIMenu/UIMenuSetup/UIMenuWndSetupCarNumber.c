...
CTRL_LIST_ITEM(UIMenuWndSetupCarnum_return)
CTRL_LIST_END
...
INT32 UIMenuWndSetupCarNumber_Tab_OnTouchPanelKey(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_TP,UIMenuWndSetupCarNumber_Tab_OnTouchPanelKey)
...
INT32 UIMenuWndSetupCarNumber_Tab_OnKeyUp(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	...
	switch (uiKeyAct)
	{
		...
		{
                        debug_msg("^G   UIMenuWndSetupCarNumber_Tab_OnKeyUp\r\n");
...
INT32 UIMenuWndSetupCarNumber_Tab_OnTouchPanelKey(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	UINT32 uiEvent;
    UINT32 P1,P2;
    UINT32  uiSoundMask;
  int i;
	...
	switch(uiEvent)
	{
		...
		case GESTURE_PRESSONLY:
			P1= paramArray[1];
			P2=paramArray[2];  
                    debug_msg("^G ==== %d\r\n",UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS));

                    switch(TPIsRangePossition(&UIMenuWndSetupCarNumber_Button1Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS) != 0)
                                {
                                UxTab_SetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS,0);
                                Ux_RedrawAllWind();
                                }
                     ...
                     switch(TPIsRangePossition(&UIMenuWndSetupCarNumber_Button2Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS) != 1)
                                {
                                UxTab_SetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS,1);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                      ...
                      switch(TPIsRangePossition(&UIMenuWndSetupCarNumber_Button3Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS) != 2)
                                {
                                UxTab_SetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS,2);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                       ...
                       switch(TPIsRangePossition(&UIMenuWndSetupCarNumber_Button4Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS) != 3)
                                {
                                UxTab_SetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS,3);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                        ...
                        switch(TPIsRangePossition(&UIMenuWndSetupCarNumber_Button5Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS) != 4)
                                {
                                UxTab_SetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS,4);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                        ...
                        case TP_PRESS_ERR:
                         ...
                         switch(TPIsRangePossition(&UIMenuWndSetupCarNumber_Button6Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS) != 5)
                                {
                                UxTab_SetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS,5);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                        ...
                        case TP_PRESS_ERR:
                          ...
                          switch(TPIsRangePossition(&UIMenuWndSetupCarNumber_Button7Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS) != 6)
                                {
                                UxTab_SetData(&UIMenuWndSetupCarNumber_TabCtrl, TAB_FOCUS,6);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                  ...
                  if(TPIsOnRange(&UIMenuWndSetupCarnum_returnCtrl,P1,P2)==TRUE)
		    {
		    UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
...
//----------------------UIMenuWndSetupCarnum_returnCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndSetupCarnum_return)
EVENT_END
