...
CTRL_LIST_ITEM(UIMenuWndSetupCommonCarnum_return)
CTRL_LIST_END
...
INT32 UIMenuWndSetupCommonCarNumber_Tab_OnTouchPanelKey(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_TP,UIMenuWndSetupCommonCarNumber_Tab_OnTouchPanelKey)
...
INT32 UIMenuWndSetupCommonCarNumber_Tab_OnTouchPanelKey(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	UINT32 uiEvent;
    UINT32 P1,P2;
    UINT32  uiSoundMask;
	...
	switch(uiEvent)
	{
		...
		case GESTURE_PRESSONLY:
			...
			P2=paramArray[2];  
                    ...
                    switch(TPIsRangePossition(&UIMenuWndSetupCommonCarNumber_Button1Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS) != 0)
                                {
                                UxTab_SetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS,0);
                                Ux_RedrawAllWind();
                                }
                     ...
                     switch(TPIsRangePossition(&UIMenuWndSetupCommonCarNumber_Button2Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS) != 1)
                                {
                                UxTab_SetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS,1);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                      ...
                      switch(TPIsRangePossition(&UIMenuWndSetupCommonCarNumber_Button3Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS) != 2)
                                {
                                UxTab_SetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS,2);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                       ...
                       switch(TPIsRangePossition(&UIMenuWndSetupCommonCarNumber_Button4Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS) != 3)
                                {
                                UxTab_SetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS,3);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                        ...
                        switch(TPIsRangePossition(&UIMenuWndSetupCommonCarNumber_Button5Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS) != 4)
                                {
                                UxTab_SetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS,4);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                        ...
                        case TP_PRESS_ERR:
                         ...
                         switch(TPIsRangePossition(&UIMenuWndSetupCommonCarNumber_Button6Ctrl,P1,P2))
                        {
                        case TP_PRESS_UP:
                            UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
                            if(UxTab_GetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS) != 5)
                                {
                                UxTab_SetData(&UIMenuWndSetupCommonCarNumber_TabCtrl, TAB_FOCUS,5);
                                Ux_RedrawAllWind();
                                }
                            else
                                Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);
                  ...
                  if(TPIsOnRange(&UIMenuWndSetupCommonCarnum_returnCtrl,P1,P2)==TRUE)
		    {
		    UISound_Play(DEMOSOUND_SOUND_KEY_TONE);	
...
//----------------------UIMenuWndSetupCommonCarnum_returnCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndSetupCommonCarnum_return)
EVENT_END
