...
SHOW_ITEM_GROUP(CMD_Group,Skin2,0,0,719,389)
...
SHOW_ITEM_GROUP(CMD_Group,Normal5,313,210,528,247)
...
SHOW_ITEM_GROUP(CMD_Group,Focused9,313,210,528,247)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable20,313,210,528,247)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable24,313,210,528,247)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed28,313,210,528,247)
...
CREATE_MENU_CTRL(UIMenuWndPlayConfirmDel_Menu,UIMenuWndPlayConfirmDel_Menu,0,257,160,472,197)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(Skin35)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin35,0,0,299,63)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text37,0,0,299,63,STRID_NULL,0,0,0,0,2,1,1,256,0,1,0,0,0,0)
SHOW_MAP_BEGIN(Normal34)
SHOW_MAP_BODY(Skin35)
SHOW_MAP_BODY(Text37)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal34,266,100,565,163)
...
CREATE_STATE_CTRL(UIMenuWndPlayConfirmDel_StatusText,0,210,50,509,113)
...
CREATE_CTRL(UIMenuWndPlayConfirmDel_Panel,UIMenuWndPlayConfirmDel_Panel,CTRL_WND,NULL,0 ,56,50,775,439)
