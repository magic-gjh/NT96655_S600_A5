...
extern VControl MenuCommonItem_ButtonMenuCtrl;//Button type 

extern VControl MenuCommonItem_ButtonUPCtrl;//Button type 

extern VControl MenuCommonItem_ButtonOKCtrl;//Button type 

extern VControl MenuCommonItem_ButtonDOWNCtrl;//Button type 
