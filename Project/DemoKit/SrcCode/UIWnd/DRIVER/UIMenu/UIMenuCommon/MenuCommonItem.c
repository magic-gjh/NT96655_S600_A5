...
CTRL_LIST_ITEM(MenuCommonItem_ButtonMenu)
CTRL_LIST_ITEM(MenuCommonItem_ButtonUP)
CTRL_LIST_ITEM(MenuCommonItem_ButtonOK)
CTRL_LIST_ITEM(MenuCommonItem_ButtonDOWN)
CTRL_LIST_END
...
INT32 MenuCommonItem_OnEdogMessage(VControl *, UINT32, UINT32 *);
INT32 MenuCommonItem_TP(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_EDOG_MESSAGE,MenuCommonItem_OnEdogMessage)
EVENT_ITEM(NVTEVT_KEY_TP,MenuCommonItem_TP)
...
INT32 MenuCommonItem_TP(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
  UINT32 uiEvent;
    UINT32 P1,P2;
    UINT32  uiSoundMask;
	...
	switch(uiEvent)
	{
		...
		case GESTURE_CKICK:
		    ...
		    if(TPIsOnRange(&MenuCommonItem_ButtonMenuCtrl,P1,P2)==TRUE)
		    	{
		    	debug_msg("^G  menu key\r\n");
		    	      Ux_PostEvent(NVTEVT_KEY_MENU, 1, NVTEVT_KEY_PRESS);	
								   
		    	}	
                    else  if(TPIsOnRange(&MenuCommonItem_ButtonUPCtrl,P1,P2)==TRUE)
    		    	{
    		    	debug_msg("^G  up key\r\n");
    		    	     Ux_PostEvent(NVTEVT_KEY_UP, 1, NVTEVT_KEY_PRESS);	
    		       	
    		    	}	
                    else  if(TPIsOnRange(&MenuCommonItem_ButtonOKCtrl,P1,P2)==TRUE)
    		    	{
    		    	debug_msg("^G  shu2 key\r\n");
    		    	     Ux_PostEvent(NVTEVT_KEY_SHUTTER2, 1, NVTEVT_KEY_PRESS);	
    		       	
    		    	}	
                    else  if(TPIsOnRange(&MenuCommonItem_ButtonDOWNCtrl,P1,P2)==TRUE)
		    	{
...
INT32 MenuCommonItem_OnKeyMenu(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
 ...
 TM_MENU*    pMenu = TM_GetMenu();
    ...
    if (pPage->TextId == STRID_SETUP)
        Ux_CloseWindowClear(&MenuCommonItemCtrl,0);
    else {
...
INT32 MenuCommonItem_OnEdogMessage(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32  uiEvent;
    EDOG_INFO EdogInfo;
...
//----------------------MenuCommonItem_ButtonMenuCtrl Event---------------------------
EVENT_BEGIN(MenuCommonItem_ButtonMenu)
EVENT_END

//----------------------MenuCommonItem_ButtonUPCtrl Event---------------------------
EVENT_BEGIN(MenuCommonItem_ButtonUP)
EVENT_END

//----------------------MenuCommonItem_ButtonOKCtrl Event---------------------------
EVENT_BEGIN(MenuCommonItem_ButtonOK)
EVENT_END

//----------------------MenuCommonItem_ButtonDOWNCtrl Event---------------------------
EVENT_BEGIN(MenuCommonItem_ButtonDOWN)
EVENT_END
