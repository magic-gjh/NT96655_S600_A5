...
#define DEFAULT_TP_UI_MAX_X   973
#define DEFAULT_TP_UI_MAX_Y   947
#define DEFAULT_TP_UI_MIN_X   34
#define DEFAULT_TP_UI_MIN_Y   92
...
//#NT#2010/09/17#Jeah Yen -end
    ...
    INT32 TP_UI_MAX_X;//960;
    INT32 TP_UI_MAX_Y;//928;
    INT32 TP_UI_MIN_X;//76;
    INT32 TP_UI_MIN_Y;//92;
}UIMenuStoreInfo;
...
typedef enum
{
    ...
    FL_EDOGMODE,    //Enter Edog UI 
    FL_EDOGVOLUME,  //Edog volume control
    FL_EDOGMUTE,    //
    FL_EDOGDRIVEMODE,    
    FL_EDOGSENSITY,
    FL_EDOGRATAR,
...
typedef enum
{
    USER_SPEED_LIMIT = 0x51,
    CITYMODE_SPEEDLIMIT= 0x52,
    RADAR_REPORT= 0x53,
    RADAR_X_REPORT= 0x54,
    DRIVING_MODE= 0x57,
    SPEED_Correction= 0x58,
    RADAR_ONOFF= 0x5c,
    RADAR_GETGPS= 0x5d,
    RadarSetCMD_END
}RadarSetCMD;
...
typedef enum
{
    USER_SPEED_LIMIT_OFF= 0,
    USER_SPEED_LIMIT_80 ,
    USER_SPEED_LIMIT_90,
    USER_SPEED_LIMIT_100,
    USER_SPEED_LIMIT_110,
    USER_SPEED_LIMIT_120,
    USER_SPEED_LIMIT_130,
    USER_SPEED_LIMIT_140,
    USER_SPEED_LIMIT_150,
    
    USER_SPEED_LIMIT_SETTING_MAX
}USER_SPEED_LIMIT_SETTING;

typedef enum
{
    CITYMODE_SPEEDLIMIT_20 = 0,
    CITYMODE_SPEEDLIMIT_30,
    CITYMODE_SPEEDLIMIT_40,
    CITYMODE_SPEEDLIMIT_50,
    CITYMODE_SPEEDLIMIT_60,
    CITYMODE_SPEEDLIMIT_70,
    CITYMODE_SPEEDLIMIT_80,
    CITYMODE_SPEEDLIMIT_90,
    CITYMODE_SPEEDLIMIT_100,
    CITYMODE_SPEEDLIMIT_110,
    CITYMODE_SPEEDLIMIT_120,
    CITYMODE_SPEEDLIMIT_SETTING_MAX
}CITYMODE_SPEEDLIMIT_SETTING;

typedef enum
{
    SPEED_Correction_OFF = 0,
    SPEED_Correction_2,
    SPEED_Correction_4,
    SPEED_Correction_6,
    SPEED_Correction_8,
    SPEED_Correction_10,
    SPEED_Correction_SETTING_MAX
}SPEED_Correction_SETTING;

typedef enum
{
    RADAR_REPORT_OFF = 0,
    RADAR_REPORT_ON,
    RADAR_REPORT_SETTING_MAX
}RADAR_REPORT_SETTING;

typedef enum
{
    RADAR_K_REPORT_OFF = 0,
    RADAR_K_REPORT_ON,
    RADAR_K_REPORT_SETTING_MAX
}RADAR_K_REPORT_SETTING;



typedef enum
{
    RADAR_X_REPORT_OFF = 0,
    RADAR_X_REPORT_ON,
    RADAR_X_REPORT_SETTING_MAX
}RADAR_X_REPORT_SETTING;
...
typedef enum
{
    ...
    DRIVING_MODE_EYE,
    DRIVING_MODE_OFF,
    DRIVING_MODE_SETTING_MAX
}DRIVING_MODE_SETTING;

typedef enum
{
    RADAR_SET_OFF = 0,
    RADAR_SET_ON,
    RADAR_ONOFF_SETTING_MAX
}RADAR_ONOFF_SETTING;
...
typedef enum{
	...
	SPEEDLIMIT_160,
	SPEEDLIMIT_MAX
}EDOG_SPEEDLIMIT_SETTING;

typedef enum{
	RADAR0_SENSITIVITY_OFF,
	RADAR_SENSITIVITY_MEDIA,
	RADAR_SENSITIVITY_HIGH,
	RADAR_SENSITIVITY_AUTO,
	RADAR_SENSITIVITY_MAX
}EDOG_RADAR_SENSITIVITY_SETTING;
...
EDOG_NO_FILE,
EDOG_PICTUREERROR,
EDOG_PLEASE_INSERT_SD,
EDOG_CLUSTER_WRONG,
EDOG_SD_CLASS4,
EDOG_SD_CLASS6,
EDOG_UPDATE_CHECKSUMING,
EDOG_UPDATE_ERROR1,
EDOG_UPDATE_ERROR2,
EDOG_UPDATE_ERROR3,
EDOG_UPDATE_ERROR4,
EDOG_UPDATE_READDATA_ERROR,
EDOG_UPDATE_CHECKSUMDATA_ERROR,
EDOG_UPDATE_LINK_OK,
EDOG_UPDATING,
EDOG_UPDATE_DONE,
EDOG_UPDATE_CONTINUSE,
EDOG_UPDATE_LINK_DEVICE,
EDOG_MSG_MAX
}EDOG_MSG;
...
typedef enum{
	...
	MENU_RADAR_MUTE,
	MENU_DRIVE_MODE,
	MENU_RADAR_SENSITIVITY,
	MENU_SPEEDLIMIT,
	MENU_SPEEDADJUST,
	MENU_BROADCAST,
	MENU_QUICK_MUTE=0X0C,
	MENU_GET_IMEI_INFO=0X0D,	
	MENU_SET_XY=0X0E,
	MENU_DEFAULTSETTING=0X0F,
	MENU_ITEM_MAX
}EDOG_MENU_ITEM;
...
typedef enum{
	MENU_MOVIE_SIZE,
	MENU_MOVIE_DUAL_REC,
	MENU_MOVIE_CYCLIC_REC,
	MENU_MOVIE_TIMELAPSE_REC,
	MENU_MOVIE_HDR,
	MENU_MOVIE_EV,
	MENU_MOVIE_MOTION_DET,
	MENU_MOVIE_AUDIO,
	MENU_MOVIE_DATEIMPRINT,
	MENU_CAR_NUM,
	MENU_MOVIE_GSENSOR,
	MENU_MOVIE_PARKING,
	MENU_MOVIE_MAX
...
typedef enum{ 
	MENU_USER_SPEED_LIMIT,
	MENU_CITYMODE_SPEEDLIMIT,
	MENU_RADAR_REPORT,
	MENU_RADAR_X_REPORT,
	MENU_DRIVING_MODE,
