...
//Edog 
#define DEFAULT_EDOGMODE        EDOG_ON
#define DEFAULT_EDOGVOLUME     EDOG_VOLUME_3
#define DEFAULT_EDOGMUTE		EDOG_MUTE_20
#define DEFAULT_EDOGSENSITY	RADAR_SENSITIVITY_AUTO
#define DEFAULT_EDOGDRIVEMODE		DRIVERMODE_SAFTY
#define DEFAULT_EDOGSPEED_LIMIT	SPEEDLIMIT_OFF
#define DEFAULT_EDOGSPEED_ADJUST	 SPEED_ADJUST_0
#define DEFAULT_EDOGBROADCAST		BROADCAST_CONCISION
#define DEFAULT_EDOGWARNING		EDOG_BATTERY_LOW
