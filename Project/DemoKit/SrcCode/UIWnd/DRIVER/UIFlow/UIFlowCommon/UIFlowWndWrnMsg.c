		...
		case GESTURE_CKICK:	
	            switch (g_uiWrnMsgIssue)
	            {
					...
					case UIFlowWndWrnMsg_StatusTXT_Msg_STRID_SD_CLASS6:
						Ux_CloseWindowClear(&UIFlowWndWrnMsgCtrl,0);
					break;
					case UIFlowWndWrnMsg_StatusTXT_Msg_STRID_PICTUREERROR:
        					Ux_CloseWindowClear(pCtrl,2,NVTRET_WARNING,NVTEVT_KEY_RIGHT);
					break;
    ...
    switch(event)
    {
        case NVTEVT_WARNING_TIMER:
            ...
            **************************************************************************************/
            ...
            if (g_uiWrnMsgIssue == FLOWWRNMSG_ISSUE_PICTURE_ERR)
                Ux_CloseWindowClear(pCtrl,2,NVTRET_WARNING,FLOWWRNMSG_ISSUE_PICTURE_ERR);
            else
